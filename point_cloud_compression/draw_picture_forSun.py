...
result_root = './results'
clustered_point_cloud_save_dir = os.path.join(result_root, "ec_point_cloud.pcd")
range_image_raw_save_dir = os.path.join(result_root, "range_image_raw.png")
